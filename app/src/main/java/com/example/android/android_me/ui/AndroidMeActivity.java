...
public class AndroidMeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(savedInstanceState == null) {
            ...
            headFragment.setListIndex(getIntent().getIntExtra(HEAD_KEY, 0));
            ...
            bodyFragment.setListIndex(getIntent().getIntExtra(BODY_KEY, 0));
            fragmentManager.beginTransaction()
            ...
            legFragment.setListIndex(getIntent().getIntExtra(LEGS_KEY, 0));
            fragmentManager.beginTransaction()
